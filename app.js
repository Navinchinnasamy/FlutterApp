...
function openModal(target = "inventory", item = null){
  ...
  $("#item-form [name=who]").closest("label").style.display = target === "shopping" ? "block" : "none";
  if (item) {
